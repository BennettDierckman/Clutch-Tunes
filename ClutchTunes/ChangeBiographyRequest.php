...
//Establishes connection with database
    ...
    $newBiography = mysqli_real_escape_string($connect, $_POST["newBiography"]);
    ...
    //$title = "lo";
        ...
        $statement = mysqli_prepare($connect, "UPDATE Users SET biography='$newBiography' WHERE username='$username'");
